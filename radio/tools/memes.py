...
# AESTHETIC------------ https://telegram.me/DKBOTZ ------------ #
...
@Client.on_message(
    filters.command(["throw", "dart", f"dart@{BOT_USERNAME}"])
)
...
@Client.on_message(
    filters.command(["roll", "dice", f"dice@{BOT_USERNAME}"])
)
...
@Client.on_message(
    filters.command(["luck", "cownd", f"luck@{BOT_USERNAME}"])
)
